    ...
    class JaNetProgram
    {
        ...
        static void Main(string[] args)
        {
            ...
            */
            ...
            networkTrainer.EpochsBeforeDropout = 0;

            // Set output files save paths
            string thesisPath = @"C:\Users\jacopo\Dropbox\Chalmers\MSc thesis\Results\LossError\";
            networkTrainer.TrainingEpochSavePath = thesisPath + "trainingEpochs.txt";
            networkTrainer.ValidationEpochSavePath = thesisPath + "validationEpochs.txt";
