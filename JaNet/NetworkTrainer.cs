...
namespace JaNet
{
    class NetworkTrainer
    {
        ...
        private void CrossEntropyGradient(int iDataPoint)
        {
            ...
            clError = Cl.SetKernelArg(OpenCLSpace.CrossEntropyGradient, 0, network.Layers[network.NumberOfLayers - 1].Input.DeltaGPU);
            clError |= Cl.SetKernelArg(OpenCLSpace.CrossEntropyGradient, 1, network.Layers[network.NumberOfLayers - 1].Output.ActivationsGPU);
            clError |= Cl.SetKernelArg(OpenCLSpace.CrossEntropyGradient, 2, trainingSet.LabelArraysGPU(iDataPoint));
            OpenCLSpace.CheckErr(clError, "TrainMNIST.CrossEntropyGradient: Cl.SetKernelArg");
            ...
            clError = Cl.EnqueueNDRangeKernel( OpenCLSpace.Queue,
                                                ...
                                                null,
                                                out clEvent);
            OpenCLSpace.CheckErr(clError, "TrainMNIST.CrossEntropyGradient: Cl.EnqueueNDRangeKernel");
